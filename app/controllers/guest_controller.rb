class GuestController < ApplicationController
  def guest
    ...
    Message.create(
      ...
      content: "Thanks for checking out my site EventSurfing, where everything is made up and the points don't matter. Take a look around! Enjoy the modals. They're pretty!"
    )
